...
public class SubActionButton extends FrameLayout {
    ...
    public SubActionButton(Context context){super(context);};

    public SubActionButton(Context context, LayoutParams layoutParams, int theme, Drawable backgroundDrawable, View contentView, final LayoutParams contentParams) {
        super(context);
     ...
     * @param params
     */
    public void setContentView(final View contentView, LayoutParams params) {
        if(params == null) {
...
//            Toast.makeText(getContext(), "Oppp!!!Null", Toast.LENGTH_SHORT).show();
//        else
