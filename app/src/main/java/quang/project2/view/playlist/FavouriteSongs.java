...
import static quang.project2.view.playlist.Playlists.lsts;
import static quang.project2.view.playlist.Playlists.ps;
import static quang.project2.view.playlist.Playlists.name;
            ...
            public void onClick(View v) {
                ...
                if(favouriteSong.size() != 0) {
                    ...
                    try {
                        ...
                        mediaPlayer.setDataSource(lsts.get(0).getPath());
                        mediaPlayer.prepare();
                        mediaPlayer.start();
                        posit = 0;
                        listSongs = lsts;
    ...
    public void displayDialog(){
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                    ...
                    playlist.remove(ps);
                    ListMusic lt = new ListMusic(name, ls);
                    playlist.add(lt);
                    write_playlist();
                    lsts = ls;
    ...
    public class SetDS extends ArrayAdapter<String> {
        ...
        public SetDS(Activity context) {
            ...
            for(Song song : mListSongs)
                for(int c = 0; c < lsts.size(); c++)
                    if (song.getName().compareTo(lsts.get(c).getName()) == 0)
                        ls.add(song);
        }
    ...
    private void displaySnackbar(String text, String actionName, View.OnClickListener action) {
        ...
        snack.show();
            ...
            private int removeSong(Song song) {
                int pos = lsts.indexOf(song);
                lsts.remove(song);
                playlist.get(ps).getListSong().remove(song);
            ...
            private void addSong(int pos, Song song) {
                lsts.add(pos, song);
                playlist.get(ps).getListSong().add(song);
